...
class SearchHotelPage:
    ...
    def set_date_range(self, check_in, check_out): 
        self.logger.info('Setting check in {checkin} and {checkout}'.format(checkin=check_in, checkout=check_out))   
    ...
    def set_travellers(self, adults, child):
        self.logger.info('Travellers adults - {adults} and child - {kids}'.format(adults=adults, kids=child))
